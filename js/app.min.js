$(function() {
  ...
  var i = 0,
      ...
      m = [
          ...
          ["午饭"],
          ["晚饭", "小饭馆 小饭馆 小饭馆 楼下套餐饭 楼下套餐饭 楼下套餐饭 楼下套餐饭 八珍面 八珍面 八珍饭 八珍饭 八珍饭 盖浇饭 砂锅 大排档 米线 满汉全席 西餐 麻辣烫 自助餐 炒面 快餐 水果 西北风 馄饨 火锅 烧烤 泡面 水饺 日本料理 涮羊肉 味千拉面 面包 扬州炒饭 自助餐 菜饭骨头汤 茶餐厅 海底捞 西贝莜面村 披萨 麦当劳 KFC 汉堡王 卡乐星 兰州拉面 沙县小吃 烤鱼 烤肉 海鲜 铁板烧 韩国料理 粥 快餐 萨莉亚 桂林米粉 东南亚菜 甜点 农家菜 川菜 粤菜 湘菜 本帮菜 生活 全家便当".split(" ")]
      ],
  ...
  m[1][1] = m[2][1], a.on("animationend webkitAnimationEnd", function(t) {
      ...
      if (g.toggleClass("playing", !i), i) i = 0, "monster" == w && x.text(u[t(u.length)]), c.text("！"), l.find("span").text("换一个"), clearTimeout(b), document.title = " | " + a.text() + "选择困难户！";
      else {
      ...
      $(this).hasClass("selected") || ($(this).addClass("selected").siblings().removeClass("selected"), w = $(this).data("type"), alert("monster" == w ? "咳咳，你准备好了吗？！" : "还是我的好吃吧 Ψ(￣∀￣)Ψ"), k = 0, _hmt.push(["_trackEvent", "type", "toggle", w]))
